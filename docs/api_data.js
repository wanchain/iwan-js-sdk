  ...
  },
  {
    ...
    "parameter": {
      ...
      "examples": [
        {
          "title": "JSON-RPC over websocket",
          "content": "{\"jsonrpc\":\"2.0\",\"method\":\"getRegisteredAds\",\"params\":{},\"id\":1}",
          "type": "string"
        }
      ]
    },
  ...
  },
  {
    ...
    "parameter": {
      ...
      "examples": [
        {
          "title": "JSON-RPC over websocket",
          "content": "{\"jsonrpc\":\"2.0\",\"method\":\"getRegisteredDapp\",\"params\":{\"after\":1577155812700},\"id\":1}",
          "type": "string"
        }
      ]
    },
  ...
  },
  {
    ...
    "parameter": {
      ...
      "examples": [
        {
          "title": "JSON-RPC over websocket",
          "content": "{\"jsonrpc\":\"2.0\",\"method\":\"getRegisteredValidator\",\"params\":{},\"id\":1}",
          "type": "string"
        }
      ]
    },
    "examples": [
      {
        "title": "Example callback usage:",
        "content": "let apiTest = new ApiInstance(YOUR-API-KEY, YOUR-SECRET-KEY);\napiTest.getRegisteredValidator((err, result) => {\n  console.log(\"Result is \", result);\n  apiTest.close();\n});",
        "type": "nodejs"
      },
      {
        "title": "Example promise usage:",
        "content": "let apiTest = new ApiInstance(YOUR-API-KEY, YOUR-SECRET-KEY);\nlet result = await apiTest.getRegisteredValidator();\nconsole.log(\"Result is \", result);\napiTest.close();",
        "type": "nodejs"
      }
    ],
    "success": {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "txObject",
            "description": "<p>A transaction object see web3.eth.sendTransaction, with the difference that for calls the from property is optional as well.</p>"
          },
          {
            "group": "Parameter",
            "type": "function",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "options",
            "description": "<p>Optional. <br>  <code>format</code> - Whether to get the serialized or decoded transaction, in this case, <code>chainType</code> should be <code>&quot;BTC&quot;</code>: <br>     Set to <code>false</code> (the default) to return the serialized transaction as hex. <br>     Set to <code>true</code> to return a decoded transaction.</p>"
          },
          {
            "group": "Parameter",
            "type": "function",
